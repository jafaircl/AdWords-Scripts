 ...
 *     AdWords accounts in parallel. See
 *     https://developers.google.com/adwords/scripts/docs/solutions/master-negative-list
 *     for more details.
 *
 ...
 * https://goo.gl/IC3JIz
 */
var SPREADSHEET_URL = 'https://docs.google.com/spreadsheets/d/1V6DgtBwLSyH9d764oQvvU1sv0o0-DAwb3jpthg5mRiA/edit';
...
function sendEmail(config, emailParams) {
  ...
  if (emailParams.Status == 'OK') {
    summary = 'The Master Negative List script successfully processed ' +
        'Customer ID: ' + AdWordsApp.currentAccount().getCustomerId() +
